...
public class TransUtil {
    ...
    public volatile static Map<String,Integer> state = new ConcurrentHashMap<>();
    public volatile static Map<String,String> mes = new ConcurrentHashMap<>();
    public volatile static Map<String,String> zls = new ConcurrentHashMap<>();
    public volatile static Map<String,List<String>> zlqueue = new ConcurrentHashMap<>();
